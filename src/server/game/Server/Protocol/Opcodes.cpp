...
void InitOpcodeTable()
{
    ...
    OPCODE( CMSG_GUILD_CHALLENGE_UPDATE_REQUEST,          STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    ...
    OPCODE( CMSG_SET_AMMO,                                STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::Handle_NULL                     );
    ...
    OPCODE( CMSG_GRANT_LEVEL,                             STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleGrantLevel                );
    ...
    OPCODE( CMSG_ACCEPT_LEVEL_GRANT,                      STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleAcceptGrantLevel          );
    ...
    OPCODE( CMSG_PORT_GRAVEYARD,                          STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMoveToGraveyard           );
    ...
    OPCODE( CMSG_CUF_PROFILES_SAVE,                       STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    OPCODE( SMSG_CUF_PROFILES_LOAD,                       STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
